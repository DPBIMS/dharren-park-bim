  ...
  return (
    <main style={{ background:'#0a0e1a', color:'#e8eaf0', minHeight:'100vh', paddingTop:'80px', fontFamily:"'DM Sans',sans-serif", display:'flex', alignItems:'center', justifyContent:'center' }}>
      <div style={{ maxWidth:'560px', width:'100%', padding:'2rem 1.5rem', textAlign:'center' }}>
        ...
        <div style={{ fontSize:'11px', fontWeight:600, letterSpacing:'2px', textTransform:'uppercase', color:'#3b82f6', marginBottom:'.75rem' }}>Software · Autodesk Cloud</div>
        <h1 style={{ fontFamily:"'Syne',sans-serif", fontSize:'2rem', fontWeight:800, letterSpacing:'-.5px', marginBottom:'.75rem' }}>Autodesk Forma</h1>
        <p style={{ color:'#8892a4', fontSize:'14px', lineHeight:'1.7', maxWidth:'400px', margin:'0 auto 2rem' }}>Use AI-powered early-stage design tools in Forma to analyse daylight, wind, noise, and greenery before you commit to a design. From first massing to Revit handoff.</p>
        <div style={{ display:'flex', gap:'.75rem', justifyContent:'center', flexWrap:'wrap', marginBottom:'2rem' }}>
          <Link href="/software/forma/getting-started" style={{ display:'inline-block', background:'#2563eb', color:'#fff', padding:'11px 28px', borderRadius:'8px', fontSize:'14px', fontWeight:700, textDecoration:'none' }}>Start the Course →</Link>
